...
for (i in 1:nreps){
   # simulate new data
E_Data <- E_Data %>% mutate(SimSpeed = b0 + b1*AGE + rnorm(n= nrow(elephants), mean=0, sd=sigma))
Mb <- lm(data=E_Data, SimSpeed~AGE)   #fit model to simulated data
...
>>>>>>> 15298962ead25ff9a230899f3be134b05f96333c

>>>>>>> 867c231afc3c8f0c2c19161847331385cb1e096a
